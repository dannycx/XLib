...
public class TipMsgLayout extends LinearLayout {
    ...
    public void setTip(int count) {
        if (count <= 0){
            ...
            tip.setTextSize(9);
            tip.setText(count + "");
            LayoutParams params = new LayoutParams(UiTool.INSTANCE.dp2px(context, 12),
                UiTool.INSTANCE.dp2px(context, 12));
            layout.setLayoutParams(params);
        }else if (count < 100) {
            tip.setTextSize(9);
            tip.setText(count + "");
            LayoutParams params = new LayoutParams(UiTool.INSTANCE.dp2px(context, 18),
                UiTool.INSTANCE.dp2px(context, 18));
            layout.setLayoutParams(params);
        }else {
            tip.setTextSize(9);
            tip.setText(99 + "+");
            LayoutParams params = new LayoutParams(UiTool.INSTANCE.dp2px(context, 22),
                UiTool.INSTANCE.dp2px(context, 22));
            layout.setLayoutParams(params);
        }
    }
