...
//        mProgress = typedArray.getInteger(R.styleable.RoundProgressBar_progress, 0);
        mBcWidth = typedArray.getDimension(R.styleable.CircleProgressBar_smallCircle, 4);
        mBcColor = typedArray.getColor(R.styleable.CircleProgressBar_smallCircleColor, Color.WHITE);
        progressColor = typedArray.getColor(R.styleable.CircleProgressBar_progressBarColor, Color.RED);
        circleColor = typedArray.getColor(R.styleable.CircleProgressBar_circleColor, Color.RED);
        smallRadius = typedArray.getDimension(R.styleable.CircleProgressBar_circleRadius, smallRadius);
        progressSize = typedArray.getDimension(R.styleable.CircleProgressBar_progressSize, 8);
        typedArray.recycle();
        initPaint();
    }
