...
public class CustomXAxisRendererRadarChart extends XAxisRendererRadarChart {
    ...
    public void renderAxisLabels(Canvas c) {
        if (this.mXAxis.isEnabled() && this.mXAxis.isDrawLabelsEnabled()) {
            ...
            float scale = radarChart.getContext().getResources().getDisplayMetrics().density;
            ...
            for (int i = 0; i < entryCount; i++) {
                ...
                mXAxis.mLabelRotatedWidth = UiTool.INSTANCE.dp2px(radarChart.getContext(), RadarChartUtil.BASE_LABEL_WIDTH_DP);
