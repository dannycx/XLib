...
public class CircleImageView extends AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a.hasValue(R.styleable.CircleImageView_circleBackground)) {
            mCircleBackgroundColor = a.getColor(R.styleable.CircleImageView_circleBackground,
                    DEFAULT_CIRCLE_BACKGROUND_COLOR);
        } else if (a.hasValue(R.styleable.CircleImageView_fillColor)) {
            mCircleBackgroundColor = a.getColor(R.styleable.CircleImageView_fillColor,
                    DEFAULT_CIRCLE_BACKGROUND_COLOR);
        }
        a.recycle();
        init();
